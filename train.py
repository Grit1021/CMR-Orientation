...
sys.path.append('/home/liyuxin/Orientation-Adjust-Tool-master/MSCMR_orient-master/code/d2l') #提示系统找到d2l包的位置
...
# net = resnet18()    #resnet18为常用的多分类网络结构 可以替换DNN
...
for epoch in range(num_epochs):
    ...
    net.train()
    for i, (X, y) in tqdm(enumerate(train_iter)):   #tqdm函数的用法
        timer.start()
        optimizer.zero_grad()
    ...
    writer.add_scalar('valid acc', valid_acc, epoch + 1)   #按照时间序列写入accuracy
