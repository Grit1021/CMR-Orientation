...
if __name__ == '__main__':
    filepath = r'D:\2021-2022\SDS\postgrad\ZMIC\Orientation-Adjust-Tool-master\data_adjusted\C0'    #文件路径是反斜杠时需要加r读取
    imgfile = r'D:\2021-2022\SDS\postgrad\ZMIC\Orientation-Adjust-Tool-master\MSCMR_orient-master\code\data_transform\C0\0'
    makedir(imgfile)
